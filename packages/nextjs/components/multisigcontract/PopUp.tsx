 ...
 */
export const PopUp = ({ string: removeOwner, updateParent: any }) => {
    ...
    <div>
      ...
      <label htmlFor="faucet-modal" className="modal cursor-pointer">
        <label className="modal-box relative">
          ...
          <h3 className="text-xl font-bold mb-3">Remove Owner {removeOwner}</h3>
          ...
          <div className="space-y-3">
            <div className="flex space-x-4">
              <div>
                <span className="text-sm font-bold">Do you want to remove: </span>
                <Address address={removeOwner} />
